...
const sortByName = (parkA, parkB) => { //accepts 2  park objects rather than 2 dom elements
  ...
  //previous wont work as event listerners are removed when rendered
  // function to handler favorite button clicks
  //after added to main modify original like this 
  //Because you attached the event listener to the 
//   <main> element, it triggers whenever a click happens 
//       anywhere on the <main>. You want to restrict the event 
//           handling to only the buttons.
// You can do a conditional check to ensure that the 
// element that triggered the event was the button.
